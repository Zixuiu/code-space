        ...
        button.setStyleSheet(f"""
            QPushButton {{
                background: qlineargradient(x1:0, y1:0, x2:0, y2:1, 
                    stop:0 {bg_color}, stop:1 {bg_color});
                color: white;
                border: none;
                border-radius: 6px;
                font-weight: bold;
...
"""
    ...
    def try_auto_login(self):
        """尝试自动登录 - 已禁用，由app.py统一处理"""
        # 不再在这里执行自动登录，由app.py中的check_auto_fill统一处理
        pass
