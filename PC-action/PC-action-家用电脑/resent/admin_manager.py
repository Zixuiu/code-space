...
class AdminManager(QMainWindow):
    ...
    def on_load_error(self, error_message):
        ...
        retry_button.setStyleSheet("""
            ...
            QPushButton:hover {
                background: qlineargradient(x1:0, y1:0, x2:0, y2:1, 
                    stop:0 #4498EB, stop:1 #3990C9);
            }
            QPushButton:pressed {
                background: qlineargradient(x1:0, y1:0, x2:0, y2:1, 
                    stop:0 #2488CB, stop:1 #1970A9);
            }
        """)
    ...
    def init_ui(self):
        ...
        self.create_user_btn.setStyleSheet("""
            ...
            QPushButton:hover {
                background: qlineargradient(x1:0, y1:0, x2:0, y2:1, 
                    stop:0 #26B095, stop:1 #239D85);
            }
            QPushButton:pressed {
                background: qlineargradient(x1:0, y1:0, x2:0, y2:1, 
                    stop:0 #069075, stop:1 #037D65);
            }
        """)
        ...
        self.mark_processed_btn.setStyleSheet("""
            ...
            QPushButton:hover {
                background: qlineargradient(x1:0, y1:0, x2:0, y2:1, 
                    stop:0 #FFAC22, stop:1 #F78E32);
            }
            QPushButton:pressed {
                background: qlineargradient(x1:0, y1:0, x2:0, y2:1, 
                    stop:0 #E38C02, stop:1 #D66E12);
            }
        """)
