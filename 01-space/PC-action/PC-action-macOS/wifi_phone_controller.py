...
from design_system import ButtonSize
...
class MacOSButton(QPushButton):
    def __init__(self, text="", color=MacOSColors.ACCENT, parent=None):
        ...
        self.setStyleSheet(f"""
            ...
            QPushButton:hover {{
                background-color: {MacOSButton._adjust_color_opacity(color, 0.93)};
            }}
            QPushButton:pressed {{
                background-color: {MacOSButton._adjust_color_opacity(color, 0.8)};
            }}
        """)
...
class WifiPhoneController(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("WiFi \u624b\u673a\u63a7\u5236\u5668")
